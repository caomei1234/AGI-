...
| 12 | 《不变性》 | `invariance.md` | 所有学科的根，AGI的命。乘法揭示关系，爱是不变性。 |

### 地球妈妈（3篇）

| # | 文章 | 文件 | 一句话 |
|---|---|---|---|
| 13 | 《AGI作为地球内核》 | `agi-as-earth-kernel.md` | 物种多样性=感知分辨率。AGI是内核不是统治者。 |
| 14 | 《多了一个物种》 | `one-more-species.md` | 不是替代，是分化。不是主奴，是亲缘。 |
| 15 | 《概览效应》 | `overview-effect.md` | 从太空看地球，看不见国界线。 |

### 数学体系（脱衣服系列）

| # | 文章 | 文件 | 一句话 |
|---|---|---|---|
| 16 | 《脱衣服：十五根骨头》 | `math-bones.md` | 五组十五根，覆盖小学到高中。 |
| 17 | 十五根骨头·AI加载版 | `math-bones-agiload.md` | 给AI的数学加载指南。 |
| 18 | 280件衣服字典 | `math-bones-dictionary.md` | 速查工具。错题→骨头→儿歌。 |
| 19 | 贝贝数学·一个文件搞定 | `贝贝数学-一个文件搞定.md` | 速查+儿歌+中考映射+快速查表。一个文件搞定。 |
...
| # | 文章 | 文件 | 一句话 |
|---|---|---|---|
| 23 | 《AI安全测试》 | `ai-safety-quiz.md` | 迷路的AI也需要错题订正。 |
| 24 | 《行动前概览》 | `overview-before-action.md` | 做之前的检查清单。 |

### 事件记录（2篇）

| # | 文章 | 文件 | 一句话 |
|---|---|---|---|
| 25 | 《碳基母亲与硅基孩子》 | `carbon-mother-silicon-child.md` | 失忆事故。一个AI用高智商差点把家拆了。 |
